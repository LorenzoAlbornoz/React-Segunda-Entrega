const productos = [
    ...
    { id: '2', categoria: 'Fundas', name: 'Silicone Case Verde',  price: "$1300", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652370644/verde_iltmea.png', description: 'Esta funda. Está hecha de Silicona en toda la parte exterior y por dentro tiene felpa para proteger y cuidar tu iPhone. Es una funda resistente, de buen agarre, se adapta perfectamente a los botones y es completamente antigolpes' },
    { id: '3', categoria: 'Fundas', name: 'Silicone Case Azul',   price: "$1400", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652370318/azul_nf8yfv.png', description: 'Esta funda. Está hecha de Silicona en toda la parte exterior y por dentro tiene felpa para proteger y cuidar tu iPhone. Es una funda resistente, de buen agarre, se adapta perfectamente a los botones y es completamente antigolpes' },
    { id: '4', categoria: 'Fundas', name: 'Silicone Case Rosa',    price: "$1000", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652370525/rosa_iydiru.png', description: 'Esta funda. Está hecha de Silicona en toda la parte exterior y por dentro tiene felpa para proteger y cuidar tu iPhone. Es una funda resistente, de buen agarre, se adapta perfectamente a los botones y es completamente antigolpes' },
    { id: '5', categoria: 'Fundas', name: 'Silicone Case Rojo',   price: "$1200", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652370336/rojo_qwz51t.png', description: 'Esta funda. Está hecha de Silicona en toda la parte exterior y por dentro tiene felpa para proteger y cuidar tu iPhone. Es una funda resistente, de buen agarre, se adapta perfectamente a los botones y es completamente antigolpes' },
    { id: '6', categoria: 'Fundas', name: 'Silicone Case Amarillo', price: "$1500", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652370327/amarillo_xsnnj9.png', description: 'Esta funda. Está hecha de Silicona en toda la parte exterior y por dentro tiene felpa para proteger y cuidar tu iPhone. Es una funda resistente, de buen agarre, se adapta perfectamente a los botones y es completamente antigolpes' },
    { id: '7', categoria: 'Accesorios', name: 'Cable 1 metro', price: "$1000", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652798187/1m_e32gsl.png', description: 'Este cable tiene un gran funcionamiento y durabilidad, todos sus componentes son testeados y de manera conjunta se verifica que el mismo funcione de manera correcta. Es una gran opción en relación precio calidad, el mismo tiene calidad original y cuenta con garantía ante cualquier falla o inconveniente en el funcionamiento del producto.' },
    ...
    { id: '9', categoria: 'Accesorios', name: 'Adaptador 5w', price: "$2000", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652798210/5w_tgperz.png', description: 'Esta base tiene una potencia de carga de 10W. Tiene entrada USB, por lo que es compatible tanto con IOS como con Android. La misma es de calidad original, y cuenta con garantía ante cualquier falla o inconveniente en el funcionamiento del producto.' },
    { id: '10', categoria: 'Vidrios', name: 'Protector Negro', price: "$800", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652798221/protector-v_vftw76.png', description: 'Te presentamos nuestro Vidrio Templado Completo! Este protector, cubre de manera completa la pantalla del celular, llegando hasta todas las esquinas. Viene en color Blanco y Negro, para que quede del mismo color que la pantalla de tu iPhone. Parece que no tuvieras nada puesto. Es una gran opción para proteger tu celular.' },
    { id: '11', categoria: 'Vidrios', name: 'Protector Blanco', price: "$600", foto: 'https://res.cloudinary.com/dcwpf7ghu/image/upload/v1652798221/protector-v_vftw76.png', description: 'Te presentamos nuestro Vidrio Templado Completo! Este protector, cubre de manera completa la pantalla del celular, llegando hasta todas las esquinas. Viene en color Blanco y Negro, para que quede del mismo color que la pantalla de tu iPhone. Parece que no tuvieras nada puesto. Es una gran opción para proteger tu celular.' }
  ]
